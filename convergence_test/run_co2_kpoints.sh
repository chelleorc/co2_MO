...
input=pwscf.in
raw_output=./convergence_test/out/pwscf_kpoints.out
processed_output=./convergence_test/_data/co2_kpoints.csv
wfc=/mnt/home/landerson1/ceph/projects/wannier/co2/wfc

rm -f $processed_output $raw_output

for k_points in 6 7 8 9 10 11 12; do
...
EOF
  ...
  mpirun -np 30 pw.x -in $input > $raw_output
   ...
   echo "${k_points}, ${total_energy}, ${wall_time}" >> $processed_output
done
